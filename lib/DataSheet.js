  ...
  _createClass(DataSheet, [
    ...
    },
    {
      ...
      value: function handleCopy(e) {
        if (isEmpty(this.state.editing)) {
          ...
          this.setState({ copiedCells: { start: start, end: end } });
        }
      },
    },
    {
      ...
      value: function handlePaste(e) {
        if (isEmpty(this.state.editing)) {
          var _getState3 = this.getState(),
            ...
            copiedCells = _getState3.copiedCells;
    ...
    },
    {
      ...
      value: function clearSelectedCells(start, end) {
        ...
        var selectedCells = this.getSelectedCells(data, start, end);
        if (onClear) {
    ...
    },
    {
      ...
      value: function searchForNextSelectablePos(
        ...
        var isCellDefined = function isCellDefined(_ref2) {
          var i = _ref2.i,
            j = _ref2.j;
        ...
        if (isEditing) {
          ...
          if (
            ...
            if (keyCode === _keys.ENTER_KEY) {
              func = function func() {
                return _this2.handleNavigate(e, { i: offset, j: 0 });
              };
            } else if (keyCode === _keys.TAB_KEY) {
              func = function func() {
                return _this2.handleNavigate(e, { i: 0, j: offset }, true);
              };
            }
            // setTimeout makes sure that component is done handling the event before we take over
            setTimeout(function () {
              func();
              _this2.dgDom && _this2.dgDom.focus();
            }, 1);
          }
        }
      },
      ...
      value: function onMouseDown(i, j, e) {
        ...
        var editing =
          ...
          this.state.editing.j !== j
            ? {}
            : this.state.editing;
        var shiftStart = isEmpty(this.state.start)
          ? this.props.selected.start
          : this.state.start;
        this._setState({
          selecting: !isNowEditingSameCell,
          start: e.shiftKey ? shiftStart : { i: i, j: j },
          end: { i: i, j: j },
          editing: editing,
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props4 = this.props,
          SheetRenderer = _props4.sheetRenderer,
          RowRenderer = _props4.rowRenderer,
          cellRenderer = _props4.cellRenderer,
          dataRenderer = _props4.dataRenderer,
          valueRenderer = _props4.valueRenderer,
          dataEditor = _props4.dataEditor,
          valueViewer = _props4.valueViewer,
          ...
          getCellContent = _props4.getCellContent,
          setCellContent = _props4.setCellContent;
            ...
            data.map(function (row, i) {
              return _react2.default.createElement(
                ...
                row.map(function (cell, j) {
                  var isEditing = _this3.isEditing(i, j);
                  return _react2.default.createElement(
                    _DataCell2.default,
                    _extends(
                      {
                        ...
                        onRevert: _this3.onRevert,
                        onNavigate: _this3.handleKeyboardCellMovement,
                        onKey: _this3.handleKey,
                        selected: _this3.isSelected(i, j),
                        editing: isEditing,
                        clearing: _this3.isClearing(i, j),
